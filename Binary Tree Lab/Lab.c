...
int hasGreatGrandchild(BTNode *node){
	...
	// if ( (node->left->left->left) != NULL) printf("%d ", node->item);
    // else if((node->left->left->right) != NULL) printf("%d ", node->item);
	// else if((node->left->right->left) != NULL) printf("%d ", node->item);
	// else if((node->left->right->right) != NULL) printf("%d ", node->item);
	// else if((node->right->left->left) != NULL) printf("%d ", node->item);
	// else if((node->right->left->right) != NULL) printf("%d ", node->item);
	// else if((node->right->right->left) != NULL) printf("%d ", node->item);
	// else if((node->right->right->right) != NULL) printf("%d ", node->item);
